...
import {metricsData} from "../../constants/metricsData.js";
import {itemsData} from "../../constants/itemData.js";
        ...
        <div className="container mx-auto py-2 px-6 md:px-4">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-[#ababab]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A atque blanditiis, eligendi fugiat, id illo ipsum laboriosam quisquam quos ratione, similique tempora. Adipisci aut id itaque omnis praesentium soluta, ut?</p>
                </div>
                <button className="flex items-center gap-2 px-4 py-2 rounded-md text-[#f5f5f5] bg-[#1a1a1a]">
                    Last 1 Month
                    <svg
                        className="w-3 h-3"
                        viewBox="0 0 24 24"
